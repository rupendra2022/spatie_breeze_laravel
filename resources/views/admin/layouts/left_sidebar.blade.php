            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-layouts">Role & Permission</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="javascript: void(0);" class="has-arrow" key="t-vertical">Roles</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="layouts-light-sidebar.html" key="t-light-sidebar">Add Roles</a></li>
                                <li><a href="layouts-compact-sidebar.html" key="t-compact-sidebar"></a></li>
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow" key="t-horizontal">Permissions</a>
                            <ul class="sub-menu" aria-expanded="true">
